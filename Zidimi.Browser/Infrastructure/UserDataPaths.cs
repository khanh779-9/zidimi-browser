...
/// All app-specific data is stored under the zidimi_ prefix:
///   zidimi_setting.json   AppSettings config (Preferences)
///   zidimi_bookmarks.json Bookmarks
///   zidimi_shortcuts.db   Shortcuts
...
public static class UserDataPaths
{
    ...
    public static string PreferencesFile(string profileName) => Path.Combine(ProfileDir(profileName), "zidimi_setting.json");

    /// <summary>The app's download list — its own SQLite (avoids touching Chromium's downloads table).</summary>
    public static string DownloadsFile(string profileName) => Path.Combine(ProfileDir(profileName), "zidimi_downloads.db");
