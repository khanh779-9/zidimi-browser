...
/// </summary>
public sealed class HecoRenderProcessMessageHandler : IRenderProcessMessageHandler
{
    ...
    {
        System.Diagnostics.Debug.WriteLine($"[Heco JS] {frame.Url}: {exception?.Message}");
    }
}